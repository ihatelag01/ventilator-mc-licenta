...
/* Definitions for myBluetoothTask */
osThreadId_t myBluetoothTaskHandle;
const osThreadAttr_t myBluetoothTask_attributes = {
  .name = "myBluetoothTask",
...
void bluetooth_fan_control()
{
 vTaskSuspend(mySensorTaskHandle);
...
int main(void)
{
  ...
  mySensorTaskHandle = osThreadNew(StartSensorTask, NULL, &mySensorTask_attributes);

  /* creation of myBluetoothTask */
  myBluetoothTaskHandle = osThreadNew(StartBluetoothTask, NULL, &myBluetoothTask_attributes);
...
/**
* @brief Function implementing the myBluetoothTask thread.
* @param argument: Not used
* @retval None
*/
